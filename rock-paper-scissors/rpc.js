...
/*Cashing the DOM means storing something for future use (storing those things in variables so we can us it later) /*DOM variables- HTML elememts that store DOM elements. 
store the reference to the element once so it is quicker and gives better performance */ 
let userScore = 0;
let computerScore = 0;
const userScore_span = document.getElementById("user-score");
const computerScore_span = document.getElementById("comp-score");
const scoreBoard_div = document.querySelector(".score-board"); /* '.' because it is a class in the HTML*/
